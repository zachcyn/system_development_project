  ...
  return (
    <>
      ...
      <Grid
        ...
        alignItems="center"
      >
        <EditedTypo variant="h1" sx={{mt:5}}>TBS 2</EditedTypo>
        <EditedTypo variant="subtitle1" textTransform="capitalize">degree of difficulty 3.25</EditedTypo>
        {TBS_data.map((elem) => (
          <Grid item key={TBS_data.indexOf(elem)} width="70%" md={2}>
              <EditedTypo 

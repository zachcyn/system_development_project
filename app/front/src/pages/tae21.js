  ...
  return (
    <>
      ...
      <Grid
        ...
        alignItems="center"
      >
        <EditedTypo variant="h1" sx={{mt:5}}>TAE 21</EditedTypo>
        <EditedTypo variant="subtitle1" textTransform="capitalize">degree of difficulty 2.3</EditedTypo>
        {TAE_data.map((elem) => (
          <Grid item key={TAE_data.indexOf(elem)} width="70%" md={2}>
              <EditedTypo 
